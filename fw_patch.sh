...
sudo echo "Starting..."
DIR=`dirname $0`
MKSQSHFS4=${DIR}'/mksquashfs4'
UNSQSHFS4=${DIR}'/unsquashfs4'
PADJFFS2=${DIR}'/padjffs2'
BINWALK=binwalk
...
case "$1" in
'--extract'|'-e')
offset0=0`${BINWALK} ${FILE_NAME} | grep 'uImage header' | awk '{print $1}'`
# offset1=0`${BINWALK} ${FILE_NAME} | grep 'Squashfs filesystem' | awk '{print $1}'`
